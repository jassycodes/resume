...
def sentiment():
	...
	class SentimentToAnalyze():
			def __init__(self, text):
				...
				self.positivetxt = os.path.realpath("../polyglot/cohort-1/data/positive-words.txt") #get address of positive-words.txt
				self.negativetxt = os.path.realpath("../polyglot/cohort-1/data/negativewords.txt") #get address of negative-words.txt
